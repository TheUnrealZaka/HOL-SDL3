...
/** Executes 'f(param1, param2)' and calculates its execution time in microseconds.
 *  This method calculates a maximum of 'maxsamples' execution times. It stops
 *  if the difference between the first and the 'k'-th sample is less than
 *  'epsilon' */
